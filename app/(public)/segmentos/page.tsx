    ...
    <>
      ...
      <section className="section-block white">
        <div className="section-inner">
          <div className="ui-reveal">
            <SectionHeader
              eyebrow="Indicadores por segmento"
              heading="As premissas mudam, mas os indicadores e a linguagem permanecem."
              subheading="Cada segmento tem variáveis específicas. O VIABIL parametriza e gera os mesmos indicadores — TIR, VPL, margem, exposição — adaptados à lógica de cada tipo de empreendimento."
            />
          </div>
          <div className="report-sample-grid ui-reveal">
            <article className="report-sample">
              <div className="report-sample-header">
                <span className="report-sample-name">Incorporação Residencial SFH</span>
                <span className="report-sample-tag">Sintético</span>
              </div>
              <div className="report-kpi-list">
                <div className="report-kpi-row">
                  <span className="report-kpi-label">VGV</span>
                ...
                <div className="report-kpi-row">
                  <span className="report-kpi-label">Financiamento SFH</span>
                  <span className="report-kpi-value neutral">60% do custo</span>
                </div>
              </div>
              <a
                className="report-sample-link"
                href="/assets/relatorios/sintetico_SFH.pdf"
                target="_blank"
            ...
            <article className="report-sample">
              <div className="report-sample-header">
                <span className="report-sample-name">Loteamento</span>
                <span className="report-sample-tag">Sintético</span>
              </div>
              <div className="report-kpi-list">
                <div className="report-kpi-row">
                  <span className="report-kpi-label">Receita bruta total</span>
                  <span className="report-kpi-value">R$ 38.400.000</span>
                </div>
                <div className="report-kpi-row">
                  <span className="report-kpi-label">TIR do empreendimento</span>
                  <span className="report-kpi-value">21,8% a.a.</span>
                </div>
                <div className="report-kpi-row">
                  <span className="report-kpi-label">Margem bruta</span>
                  <span className="report-kpi-value">41,2%</span>
                </div>
                <div className="report-kpi-row">
                  <span className="report-kpi-label">Prazo de comercialização</span>
                  <span className="report-kpi-value neutral">36 meses</span>
                </div>
                <div className="report-kpi-row">
                  <span className="report-kpi-label">Permuta com terrenista</span>
                  <span className="report-kpi-value neutral">22% dos lotes</span>
                </div>
              </div>
              <a
                className="report-sample-link"
              ...
              >
                ...
                Ver fluxo consolidado
              </a>
            </article>

            <article className="report-sample">
              <div className="report-sample-header">
                <span className="report-sample-name">Ativo de Renda</span>
                <span className="report-sample-tag">Participantes</span>
              </div>
              <div className="report-kpi-list">
                <div className="report-kpi-row">
                  <span className="report-kpi-label">Cap rate alvo</span>
                  <span className="report-kpi-value">7,8% a.a.</span>
                </div>
                <div className="report-kpi-row">
                  <span className="report-kpi-label">TIR do investidor</span>
                  <span className="report-kpi-value">16,4% a.a.</span>
                </div>
                <div className="report-kpi-row">
                  <span className="report-kpi-label">MTIR do investidor</span>
                  <span className="report-kpi-value">14,2% a.a.</span>
                </div>
                <div className="report-kpi-row">
                  <span className="report-kpi-label">Vacância estimada</span>
                  <span className="report-kpi-value neutral">8%</span>
                </div>
                <div className="report-kpi-row">
                  <span className="report-kpi-label">Saída do investimento</span>
                  <span className="report-kpi-value neutral">60 meses</span>
                </div>
              </div>
              <a
                className="report-sample-link"
